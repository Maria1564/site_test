<section class="development-stages">
    <div class="development-stages__wrapper">
        ...
        <div class="development-stages__nav">
            <div class="development-stages__arrow development-stages__arrow--prev" type="button" aria-label="Назад">
                <img src="./img/arrow-left.svg" alt="arrow left">
            </div>
            <div class="development-stages__arrow development-stages__arrow--next" type="button" aria-label="Вперёд">
